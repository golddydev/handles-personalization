...
Promise.all([
    ...
    tester.testDenial("UPDATE_NFT_HANDLE", "missing bg reference input", ["good_datum", "update_nft_redeemer_good", "missing_bg_ref_input"], "bg_policy_ids reference input not present"),
    tester.testDenial("UPDATE_NFT_HANDLE", "missing pfp reference input", ["good_datum", "update_nft_redeemer_good", "missing_pfp_ref_input"], "pfp_policy_ids reference input not present"),
